...
class BackgroundSubtractor:
    ...
    def __init__(self, min_accuracy=0.1, min_blend_area=3, kernel_fill=20, dist_threshold=15000, history=200, bs_type="MOG2"):
    ...
    def subtract_background(self):
        if self.bs_type == "MOG2":
            self.fgbg = cv2.createBackgroundSubtractorMOG2(detectShadows=True, history=self.history, varThreshold=10)
        else:
